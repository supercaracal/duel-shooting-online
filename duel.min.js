...
this.timekeeper=new TimeKeeper;this.condition=new Condition;this.game=new Game(this.routine.bind(this));this.renderElements();(function(){this.opening.hide();this.start()}).bind(this).delay(3)},setupColor:function(){this.colors={a:["white","red","navy"][Math.floor(100*Math.random())%3],b:["white","red","navy"][Math.floor(100*Math.random())%3]}},setupSound:function(){var a=new Sound;this.sounds={};this.sounds.hit=a.createAudio("/se/hit.mp3");this.sounds.lose=a.createAudio("/se/lose.mp3");this.sounds.newtype=
a.createAudio("/se/newtype.mp3");this.sounds.attack=a.createAudio("/se/attack.mp3");this.sounds.megaCannon=a.createAudio("/se/mega.mp3");this.sounds.funnelGo=a.createAudio("/se/funnel1.mp3");this.sounds.funnelAtk=a.createAudio("/se/funnel2.mp3");this.sounds.iField=a.createAudio("/se/at_field.mp3")},setupFactories:function(){this.factories={};this.factories.a=ShipFactory.getCreater(this.colors.a,!1,this.sounds);this.factories.b=ShipFactory.getCreater(this.colors.b,!0,this.sounds)},setupShips:function(){this.ships=
...
a.getLeft())}.bind(this)),this.playSoundFunnelAttack();else{var a=new FunnelCircle(this.ship);this.ship.addFunnel(a);this.funnelCircles.push(a);a.renderElement();this.playSoundFunnelGo()}},addIField:function(a){var b=new IField(this.ship),c=new WeaponWaitStatusIField(this.ship);b.setSound(a);b.setWaitStatus(c);this.elms.push(b);this.elms.push(c);b.renderElement();c.renderElement()},addFunnelDefences:function(){var a=new FunnelDefenceLeft(this.ship,this.ship.getIField()),b=new FunnelDefenceRight(this.ship,
this.ship.getIField());this.elms.push(a);this.elms.push(b);a.renderElement();b.renderElement()},addWeaponWaitStatusMegaCannon:function(){var a=new WeaponWaitStatusMegaCannon(this.ship);this.elms.push(a);a.renderElement()},removeFunnelCircle:function(a){var b;(b=this.funnelCircles.shift())&&b.remove();this.ship.funnels.shift();1<a&&((b=this.funnelCircles.shift())&&b.remove(),this.ship.funnels.shift())},fireMegaCannon:function(){0<this.megaCannonWaitCount||(this.ship.disableMegaCannonStatus(),this.megaCannonWaitCount=
this.MEGA_CANNON_WAIT,this.megaCannonHeightCount=this.MEGA_CANNON_HEIGHT,this.playSoundMegaCannon())}}),WeaponWaitStatus=Class.create(Sprite,{ship:null,isWeaponWaitStatus:!0,initialize:function($super,b){this.ship=b;$super()},createElement:function(){var a=this.getColor();return(new Element("div")).setStyle({width:"0px",height:"6px",backgroundColor:a,zIndex:this.Z_INDEX_BASE+11,position:"fixed",boxShadow:"0px 0px 1px "+a,borderRadius:"1px"})},getColor:function(){return"#FF0099"},getInitTop:function(){return this.ship.getTop()+
(this.ship.isEnemy?42:12)},getInitLeft:function(){return this.ship.getLeft()+35},setWidth:function(a,b){this.elm.setStyle({width:Math.floor(20*a/b)+"px"})},move:function(){this.setLeft(this.ship.getLeft()+35)}}),WeaponWaitStatusIField=Class.create(WeaponWaitStatus,{getColor:function(){return"#99FF00"}}),WeaponWaitStatusMegaCannon=Class.create(WeaponWaitStatus,{isWeaponWaitStatusMegaCannon:!0});