...
this.shadowSize+"px "+b});this.elm.down(1).setStyle({boxShadow:"0px 0px "+this.shadowSize+"px "+b});50<this.shadowSize&&(this.shadowSize=20,this.colors.push(this.colors.shift()))}}),ShipRed=Class.create(Ship,{soundNewtype:null,iField:null,funnels:null,initialize:function($super,b){$super(b);this.funnels=[]},getColor:function(){return"#FF5555"},setSoundNewtype:function(a){this.soundNewtype=a},playSoundNewtype:function(){this.soundNewtype&&this.soundNewtype.replay()},setIField:function(a){this.iField=
a},getIField:function(){return this.iField},getIFieldInfo:function(){return{isActive:this.iField.isActive,height:this.iField.getHeight()}},getFunnelInfo:function(){return{firstLeft:this.funnels[0]?this.funnels[0].initLeft:null,firstTheta:this.funnels[0]?this.funnels[0].theta:null,secondLeft:this.funnels[1]?this.funnels[1].initLeft:null,secondTheta:this.funnels[1]?this.funnels[1].theta:null}},addFunnel:function(a){this.funnels.push(a)},isIFieldEnable:function(){return!this.iField.isActive&&!this.iField.waitCount},
...
this.megaCannonWaitCount=0;this.elms=[]},move:function(){0<this.megaCannonWaitCount&&(--this.megaCannonWaitCount,this.megaCannonWaitCount||this.ship.enableMegaCannonStatus());0<this.megaCannonHeightCount&&(0===this.megaCannonHeightCount%3&&this.addBulletLinearFromMegaCannon(),--this.megaCannonHeightCount);this.funnelCircles.each(function(a){a.move()});for(var a=0,b=this.elms.size();a<b;a++)this.elms[a].move(),this.elms[a].isFunnelSliderAttack&&(this.addBulletLinearFromFunnel(this.elms[a].getLeft()),
this.elms[a].isFunnelSliderAttack=!1),this.elms[a].isWeaponWaitStatusMegaCannon&&this.elms[a].setWidth(this.megaCannonWaitCount,this.MEGA_CANNON_WAIT),this.elms[a].isFunnelSlider&&(this.funnelSliderCount<=this.FUNNEL_SLIDER_MAX?this.ship.enableFunnelStatus():this.ship.disableFunnelStatus()),this.elms[a].isDelete&&(this.elms[a].isFunnelSlider&&--this.funnelSliderCount,this.elms[a]=null);this.elms=this.elms.compact()},setSoundFunnelGo:function(a){this.soundFunnelGo=a},setSoundFunnelAttack:function(a){this.soundFunnelAttack=
a},setSoundAttack:function(a){this.soundAttack=a},setSoundMegaCannon:function(a){this.soundMegaCannon=a},playSoundFunnelGo:function(){this.soundFunnelGo&&this.soundFunnelGo.replay()},playSoundFunnelAttack:function(){this.soundFunnelAttack&&this.soundFunnelAttack.replay()},playSoundAttack:function(){this.soundAttack&&this.soundAttack.replay()},playSoundMegaCannon:function(){this.soundMegaCannon&&this.soundMegaCannon.replay()},addBulletLinear:function(){var a=new BulletLinear(this.ship,this.enemy);
this.elms.push(a);a.renderElement();this.playSoundAttack()},addBulletHoming:function(){var a=new BulletHoming(this.ship,this.enemy);this.elms.push(a);a.renderElement();this.playSoundAttack()},addBulletBezierAuto:function(){var a=this.enemy.getLeft(),b=new BulletBezier(this.ship,this.enemy,a-60),c=new BulletBezier(this.ship,this.enemy,a+30),a=new BulletBezier(this.ship,this.enemy,a+120);this.elms.push(b);this.elms.push(c);this.elms.push(a);b.renderElement();c.renderElement();a.renderElement();this.playSoundAttack()},
addBulletBezierManual:function(a){a=new BulletBezier(this.ship,this.enemy,a);this.elms.push(a);a.renderElement();this.playSoundAttack()},addBulletLinearFromFunnel:function(a){var b=new BulletLinear(this.ship,this.enemy);b.setPos({top:this.ship.isEnemy?90:b.clientHeight-120,left:a});this.elms.push(b);b.renderElement();this.playSoundFunnelAttack()},addBulletLinearFromMegaCannon:function(){var a=new BulletLinear(this.ship,this.enemy),b=new BulletLinear(this.ship,this.enemy),c=new BulletLinear(this.ship,
...
this.ship.addFunnel(a);this.funnelCircles.push(a);a.renderElement();this.playSoundFunnelGo()}},addIField:function(a){var b=new IField(this.ship),c=new WeaponWaitStatusIField(this.ship);b.setSound(a);b.setWaitStatus(c);this.elms.push(b);this.elms.push(c);b.renderElement();c.renderElement()},addFunnelDefences:function(){var a=new FunnelDefenceLeft(this.ship,this.ship.getIField()),b=new FunnelDefenceRight(this.ship,this.ship.getIField());this.elms.push(a);this.elms.push(b);a.renderElement();b.renderElement()},
addWeaponWaitStatusMegaCannon:function(){var a=new WeaponWaitStatusMegaCannon(this.ship);this.elms.push(a);a.renderElement()},removeFunnelCircle:function(a){var b;(b=this.funnelCircles.shift())&&b.remove();this.ship.funnels.shift();1<a&&((b=this.funnelCircles.shift())&&b.remove(),this.ship.funnels.shift())},fireMegaCannon:function(){0<this.megaCannonWaitCount||(this.ship.disableMegaCannonStatus(),this.megaCannonWaitCount=this.MEGA_CANNON_WAIT,this.megaCannonHeightCount=this.MEGA_CANNON_HEIGHT,this.playSoundMegaCannon())}}),
WeaponWaitStatus=Class.create(Sprite,{ship:null,isWeaponWaitStatus:!0,initialize:function($super,b){this.ship=b;$super()},createElement:function(){var a=this.getColor();return(new Element("div")).setStyle({width:"0px",height:"6px",backgroundColor:a,zIndex:this.Z_INDEX_BASE+11,position:"fixed",boxShadow:"0px 0px 1px "+a,borderRadius:"1px"})},getColor:function(){return"#FF0099"},getInitTop:function(){return this.ship.getTop()+(this.ship.isEnemy?42:12)},getInitLeft:function(){return this.ship.getLeft()+
35},setWidth:function(a,b){this.elm.setStyle({width:Math.floor(20*a/b)+"px"})},move:function(){this.setLeft(this.ship.getLeft()+35)}}),WeaponWaitStatusIField=Class.create(WeaponWaitStatus,{getColor:function(){return"#99FF00"}}),WeaponWaitStatusMegaCannon=Class.create(WeaponWaitStatus,{isWeaponWaitStatusMegaCannon:!0});